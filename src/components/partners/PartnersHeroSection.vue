<template>
  <section class="relative overflow-hidden bg-slate-950 text-white min-h-[280px]">
    ...
    <div
      class="relative z-10 mx-auto flex min-h-[38vh] w-full max-w-7xl items-center px-6 py-12 sm:px-8 md:px-10 md:py-14 lg:px-16 lg:py-16"
    >
      <div class="max-w-2xl">
        <p
