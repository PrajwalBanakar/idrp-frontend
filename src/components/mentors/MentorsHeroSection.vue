<template>
  <section class="relative h-[38vh] min-h-[280px] overflow-hidden bg-slate-950">
    <div class="absolute inset-0 bg-gradient-to-r from-slate-950/95 via-teal-950/80 to-teal-700/35" />
    <div
