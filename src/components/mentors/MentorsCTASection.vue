      ...
      >
        ...
        >
          ...
          <div class="flex shrink-0 flex-col gap-4 sm:flex-row">
            <RouterLink
              to="/about-idrp"
              class="inline-flex min-w-[180px] items-center justify-center rounded-full bg-teal-600 px-6 py-3 text-sm font-semibold text-slate-950 shadow-lg shadow-black/20 transition-all duration-300 hover:-translate-y-0.5 hover:bg-teal-700"
            >
              About IDRP
            </RouterLink>
