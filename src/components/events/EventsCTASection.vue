    ...
    <div class="mx-auto max-w-6xl">
      ...
      >
        ...
        >
          ...
          <RouterLink
            :to="buttonTo"
            class="inline-flex min-w-[200px] shrink-0 items-center justify-center rounded-full bg-teal-600 px-6 py-3 text-sm font-semibold text-slate-950 shadow-lg shadow-black/20 transition-all duration-300 hover:-translate-y-0.5 hover:bg-teal-700"
          >
            {{ buttonLabel }}
          </RouterLink>
        </div>
